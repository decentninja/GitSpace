...
var app = angular.module('starter', ['ionic', 'ngCordova', 'starter.controllers', 'ngWebsocket'])
.run(function($ionicPlatform, $rootScope, $websocket) {
  $ionicPlatform.ready(function() {
    ...
    */
    ...
    ws.$on('$open', function () {
      ws.$emit('clientConnected', 'message');
      ws.$emit('initialState', JSON.stringify({ data: [{
        name: "Web Client",
        issues: 5,
        files: 22,
        directories: 4,
...
.$on('initialState', function (data) {
  ...
  $rootScope.repositories = json.data;
  $rootScope.$broadcast("initialStateSet");
});
});
})

.factory('Repositories', ['$http', '$rootScope', function ($http, $rootScope) {

  var repositories = [];

  $rootScope.$on("initialStateSet", function() {
    console.log($rootScope.repositories);
    repositories = $rootScope.repositories;
...
.config(['$stateProvider', '$urlRouterProvider', function($stateProvider, $urlRouterProvider) {
  ...
  .state('app.trackpad', {
    ...
    views: {
      'appContent' :{
        templateUrl: 'views/trackpad.html',
        controller : "trackPadCtrl"
      }
    }
  })
